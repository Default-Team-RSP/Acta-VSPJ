            ...
            if($result->num_rows > 0){
                ...
                while($row = $result->fetch_assoc()){
                        ...
                        echo "<tr>
                                    ...
                                    echo"<td class='data-bs-toggle='tooltip' title='Oponentní formulář''><a href='dashboard.php?link=setreview&aid={$row['ArticleID']}'><img src='assets/img/form.svg' class='icon'></a></td>";
                        echo "</tr>";
                }
