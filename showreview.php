                ...
                Oponentní formulář
                    ...
                    <form action="./dashboard.php?link=setreview" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="range" class="form-range" min="0" max="10" step="1" onchange="updateTextInput(this.value, 'asset');" disabled>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="range" class="form-range" min="0" max="10" step="1" onchange="updateTextInput(this.value, 'originality');" disabled>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="range" class="form-range" min="0" max="10" step="1" onchange="updateTextInput(this.value, 'expertness');" disabled>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="range" class="form-range" min="0" max="10" step="1" onchange="updateTextInput(this.value, 'grammar');" disabled>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="reference" onclick="yesno(this, 'yesnos');" disabled />
                            </div>
